...
--
CREATE DATABASE IF NOT EXISTS `connectionservice` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO `connection` (`ConnectionID`, `units`, `type`, `status`) VALUES
(1, '300', 'Domestic', 'Requested'),
(2, '200', 'Hotel', 'Pending');
...
--
ALTER TABLE `connection`
  MODIFY `ConnectionID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
(6, 1, NULL, '2022-05-15', '2022-06-14', 'Pending', 4400, 193963.5);
...
(1, 1, 'established', '3 Phase', 4500),
(25, 1, 'Established', 'Hotel', 2000),
(27, 1, 'Established', 'Domestic', 1000);
...
--
ALTER TABLE `connection`
  MODIFY `connectionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `notice`
  MODIFY `noticeID` int(255) NOT NULL AUTO_INCREMENT;
